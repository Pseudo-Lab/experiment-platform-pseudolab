...
### 2단계: 환경 변수(.env) 설정
루트 디렉토리 및 `backend/` 디렉토리에 필요한 `.env` 파일을 설정해야 합니다.
...
- `docker compose logs -f experiment-platform-pseudolab-backend`
- `docker compose logs -f experiment-platform-pseudolab-frontend`
